...
public class ImportQuestionExcelWindow : MonoBehaviour
{
    ...
    private void ImportNewQuastions()
    {
        ...
        for (int i = workSheet.Dimension.Start.Row; i <= end.Row; i++)
        {
            ...
            DatabaseConnector.AddQuestion(_id, question[0],question[2], question[4], question[5], question[6], question[3], question[1]);
        }
